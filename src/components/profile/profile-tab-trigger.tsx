...
const ProfileTabTrigger = ({
  ...
  return (
    <TabsTrigger
      value={value}
      className="flex-1 h-16 py-3 px-4 justify-start items-start gap-3 border text-foreground data-[state=active]:text-white data-[state=active]:bg-[#6399CE] data-[state=active]:border-transparent transition-colors min-w-48"
    >
