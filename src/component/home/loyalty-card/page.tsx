  ...
  return (
    <div className="w-[1200px] h-[560px] flex flex-col justify-between gap-5 m-auto mb-[60px]">
      ...
      <div className="w-full h-[430px] border">
        <div className="w-full h-[65px] flex justify-between items-center border">
          ...
          <div className="w-fit h-full flex">
            <div
              ...
              className={`w-1/2 h-full text-[18px] font-bold flex items-center justify-center gap-1 border border-t-0 border-b-0 p-[17px] ${
                selectedItem === "LIST"
                  ? "bg-[#ebfaff] text-[#0087FF]"
                  : "text-gray-800"
              }`}
            ...
            <div
              ...
              className={`w-1/2 h-full text-[18px] font-bold flex items-center justify-center gap-1 p-[17px] ${
                selectedItem === "MAP"
                  ? "bg-[#ebfaff] text-[#0087FF]"
                  : "text-gray-800"
              }`}
        ...
        <div className="w-full h-fit flex flex-col gap-[24px] py-[24px]">
